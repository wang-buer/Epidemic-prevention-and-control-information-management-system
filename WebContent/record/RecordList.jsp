...
<script src="<%=basePath%>js/pintuer.js"></script>
  <script type="application/javascript">
    ...
    function del(){
      ...
      form1.action = "/IMSFEPAC/Record/deletes.do";
      form1.submit();
    }
  </script>
</head>
...
<div class="panel admin-panel">
  <form id="form1" role="form" name="form" action="/Prevention/Record/queryByKeyWords.do" method="post">
  ...
  <table class="table table-hover text-center">
   ...
   <c:forEach items="${rList}" var="rec">
    <tr>
      ...
      <a class="button border-main" href="/Prevention/Record/edit.do?rId=${rec.rId}"><span class="icon-edit"></span> 修改</a>
      <a onclick="return delete_onclick()" class="button border-red" href="/Prevention/Record/delete.do?rId=${rec.rId}"><span class="icon-trash-o"></span> 删除</a>
      </div></td>
    </tr>
  </c:forEach>
    <tr>
      <td colspan="7">
        <div class="pagelist"> <a href="/Prevention/Record/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex-1}" id="pPage">上一页</a>
          ...
          <a href="/Prevention/Record/queryAll.do?currentPageIndex=${pageUtil.currentPageIndex+1}" id="nPage">下一页</a>
...
<div class="panel admin-panel margin-top" id="add">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="/Prevention/Record/add.do">
